...
# =========================
def main():
    # npz_files = sorted(ROOT_DIR.glob("sub*/thera*/3d_kp_*PA.npz"))  #3視点の結果
    # npz_files = sorted(ROOT_DIR.glob("sub*/thera*/3d_kp_*PT.npz"))  #3視点の結果
    # npz_files = sorted(ROOT_DIR.glob("sub*/thera*/3d_kp_*PA_spline.npz"))  #3視点の結果
    npz_files = sorted(ROOT_DIR.glob("sub*/thera*/3d_kp_*PT_spline.npz"))  #3視点の結果
    # npz_files = sorted(ROOT_DIR.glob("sub*/thera*/3d_kp_*_fl-fr.npz"))  #2視点の結果(flとfr)
    # npz_files = sorted(ROOT_DIR.glob("sub*/thera*/3d_kp_*_fr-sagi.npz"))  #2視点の結果(frとsagi)
    if not npz_files:
