...
# --- 1. フォルダ選択 ---
selpath = r'G:\gait_pattern\BR9G_shuron\sub1\thera1-0\fl_\openpose.json'
...
# ★ 保存先のパスを記入
os.makedirs(os.path.dirname(selpath), exist_ok=True) # 保存先フォルダがなければ作成
filename = os.path.join(os.path.dirname(selpath), f"{title}.csv")
