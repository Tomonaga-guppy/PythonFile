...
selpath = filedialog.askdirectory(
    initialdir=r'G:\gait_pattern\20250811_br\sub1\thera0-3\fl\openpose.json' # ←←←←←←←←jsonファイルがあるフォルダの親パスを記入★
)
...
if not selpath:
    ...
    # ★ 保存先のパスを記入
    output_path = r'G:\gait_pattern\20250811_br\sub1\thera0-3\fl\json_excel'
