...
def main():
    ...
    for i, csv_path in enumerate(csv_paths):
        ...
        # #####################################
        # 結果保存ディレクトリ作成
        op_result_dir = csv_path_dir.parent / "OpenPose3D_results_maxpeople1_2dbutter"
        op_result_dir.mkdir(parents=True, exist_ok=True)

        openpose_npz_path = csv_path_dir.parent / "3d_kp_data_openpose_butter_maxpeople1.npz"
