...
def main():
    ...
    for subject_dir in subject_dirs:
        ...
        for thera_dir in thera_dirs:
            ...
            openpose_csv_path1 = thera_dir / "fl_" / "openpose_butter.csv"
            openpose_csv_path2 = thera_dir / "fr_" / "openpose_butter.csv"
            ...
            # キーポイント出力ディレクトリ作成
            timeseries_dir = thera_dir / "keypoint_timeseries_maxpeople1_2dbutter"
            ...
            output_anim_dir = thera_dir / "3d_gait_anim_raw_maxpeople1_2dbutter"
