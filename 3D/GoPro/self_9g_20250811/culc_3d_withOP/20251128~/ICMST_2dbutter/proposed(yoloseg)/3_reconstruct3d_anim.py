...
def plot_keypoint_timeseries(raw_data, filtered_data, spline_data, filt_data, confidences_3d,
    ...
    for kp_idx in tqdm(range(num_keypoints)):
        ...
        # 保存
        output_path = save_dir / f"kp{kp_idx:02d}_{kp_name}.png"
...
def main():
    ...
    for subject_dir in subject_dirs:
        ...
        for thera_dir in thera_dirs:
            ...
            openpose_csv_path1 = thera_dir / "fl_yoloseg" / "openpose_butter.csv"
            openpose_csv_path2 = thera_dir / "fr_yoloseg" / "openpose_butter.csv"
            ...
            print(f"  - 3Dキーポイントデータを保存しました。{npz_path}")

            # キーポイント出力ディレクトリ作成
            timeseries_dir = thera_dir / "keypoint_timeseries_yoloseg_2dbutter"
            ...
            output_anim_dir = thera_dir / "3d_gait_anim_yoloseg_2dbutter"
