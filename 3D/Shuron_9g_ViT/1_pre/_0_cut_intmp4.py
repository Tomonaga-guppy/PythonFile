...
def main():
    ...
    for direction in directions:
        video_path = root_dir / direction / "20250811_fault" / "cali.mp4"
        output_dir = root_dir / direction / "20250811_fault" / "cali_imgs"

        cali_video_paths.append(video_path)
        cali_output_dirs.append(output_dir)
        cali_video_names.append(f"cali")

    extract_synchronized_frames(cali_video_paths, cali_output_dirs, 40, cali_video_names)

    # near.MP4から60枚の同期フレームを抽出
    print("near.MP4 から60枚の同期フレーム抽出中...")
    ...
    for direction in directions:
        video_path = root_dir / direction / "20250811_fault" / "near.MP4"
        output_dir = root_dir / direction / "20250811_fault" / "cali_imgs"
    ...
    extract_synchronized_frames(near_video_paths, near_output_dirs, 20, near_video_names)
