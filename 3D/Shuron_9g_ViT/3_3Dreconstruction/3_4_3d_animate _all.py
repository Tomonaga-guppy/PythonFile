...
# どれを対象にするか
PA_GLOB = "sub*/thera*/3d_kp_ViTPose_*PA.npz"
# PA_GLOB = "sub*/thera*/3d_kp_ViTPose_*PA_spline.npz"
...
def update_frame_dual(i, data_pa, conf_pa, data_pt, conf_pt,
                      scat_pa, lines_pa, scat_pt, lines_pt, ax, frame_text, frame_offset):
...
def make_animation_dual(data_pa, conf_pa, data_pt, conf_pt, out_mp4, title, frame_offset):
    ...
    ani = animation.FuncAnimation(
        ...
        update_frame_dual,
        frames=n_frames,
        fargs=(data_pa, conf_pa, data_pt, conf_pt, scat_pa, lines_pa, scat_pt, lines_pt, ax, frame_text, frame_offset),
...
def run_one_pair(pa_path_str: str, pt_path_str: str):
    ...
    try:
        ...
        make_animation_dual(data_pa, conf_pa, data_pt, conf_pt, out_mp4, title, frame_offset=s)
