...
root_dir = r"G:\gait_pattern\20241111\gopro"

# keyward = "sub3_normalgait_f_1_405_dev0"
keyward = "front"
ori_mov_paths = glob.glob(os.path.join(root_dir, (keyward), '*gait_n.MP4'))
print(os.path.join(root_dir, ("*" + keyward + "*"), '*gait_n.MP4'))
...
for i, ori_mov_path in enumerate(ori_mov_paths):
    ...
    pre_video_place= " --video " + dir_name +"/gait_n.MP4"
