...
def main():
    ...
    for i, csv_path in enumerate(csv_paths):
        ...
        for frame_num in full_range:
            ...
            # r_hip_abduction_angle = R.from_matrix(rknee_realative_rotation_rl).as_euler('yxz', degrees=True)[1]
            ...
            if plot_flag:
                ...
                # if frame_num == 1756-1650:  #100Hzで2926(足を最大に外転してるくらいの時)
                    ...
                    ax.plot([lfoot[0], lfoot[0] + e_x_lfoot[0]], [lfoot[1], lfoot[1] + e_y_lfoot[1]], [lfoot[2], lfoot[2] + e_z_lfoot[2]], color='green')
