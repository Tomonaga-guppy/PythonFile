...
for i, ori_mov_path in enumerate(ori_mov_paths):
    ...
    pre_video_place= " --image_dir " + dir_name +"/Depth_image"
    after_video_place= " --write_video " + dir_name + "/estimated_depth.avi"  #動画で出力
    after_json_place= " --write_json " + dir_name + "/estimated_depth.json"  #各キーポイントの座標をjsonで出力
    other_order= " --number_people_max 2 --scale_number 2 --scale_gap 0.2 --write_video_fps 30"
