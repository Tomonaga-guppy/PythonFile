...
root_dir = r"c:\Users\tus\Desktop\record\recorded_data\realsense\two_dev"
...
bagfile1_name = os.path.join(root_dir, f'output_device1_{input_name}.bag')
bagfile2_name = os.path.join(root_dir, f'output_device2_{input_name}.bag')

if os.path.exists(bagfile1_name) and os.path.exists(bagfile2_name):
    bagfile_num = len(glob.glob(os.path.join(root_dir, f'output_device1_{input_name}*.bag')))
    bagfile2_num = len(glob.glob(os.path.join(root_dir, f'output_device2_{input_name}*.bag')))
    bagfile1_name = os.path.join(root_dir, f'output_device1_{input_name}_{bagfile_num+1}.bag')
    bagfile2_name = os.path.join(root_dir, f'output_device2_{input_name}_{bagfile2_num+1}.bag')
