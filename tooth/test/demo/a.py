...
#計算グラフの表示も一応できるらしい:https://dreamer-uma.com/pytorch-calculation-graph/

#グラフの描写 
plt.figure(figsize=(6,6))
print(range(epoch),train_loss_sum.detach().numpy())
exit()
plt.plot(range(epoch), train_loss_sum.detach().numpy())
