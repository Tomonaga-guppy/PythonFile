...
def MakeGraph(root_dir, fps, EndTimeOfTerm1, EndTimeOfTerm2):
    ...
    for i,npy_file in enumerate(npy_files):
        ...
        for i in range(aa.shape[0]):
            ...
            #e_YL (31,31のmid → 27のベクトル)
            bector_ymid = [(aa[i][31][1]+aa[i][35][1])/2, (aa[i][31][2]+aa[i][35][2])/2, (aa[i][31][4]+aa[i][35][4])/2]
            bector_y = [aa[i][27][1]-bector_ymid[0], aa[i][27][2]-bector_ymid[1], aa[i][27][4]-bector_ymid[2]]
            print('bectory=',bector_y)
        ...
        path = dir_path + "XYZ_localdata_mid.npy"
        ...
        plt.savefig(dir_path + "frontalmid.png")
        ...
        plt.savefig(dir_path + "sagittalmid.png", bbox_inches='tight')
