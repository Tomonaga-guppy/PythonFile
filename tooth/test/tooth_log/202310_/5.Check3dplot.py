...
data = np.load("C:/Users/Tomson/BRLAB/tooth/Temporomandibular_movement/movie/2023_06_06/20230606_mkg2/XYZ_localdata_rotate.npy",allow_pickle=True)

save_dir = Path('C:/Users/zutom/BRLAB/tooth/Temporomandibular_movement/movie/2023_06_06/20230606_mkg2')
...
# アニメーションを保存する
anim.save(save_dir/'animationlocal_rotate theta.mp4', fps=30)