...
dir_path = glob.glob(os.path.join(root_dir,"*e"))[0]
...
def save_frames(video_path, output_dir):
    ...
    for i in range(1,frame_count):
            ...
            if ret:
                ...
                # 画像を保存する範囲を指定
                # frame = frame[700:1180,430:910]  # 1920*1080 →480*480に切り取り  aの場合
                # frame = frame[700:1180,600:1080]  # 1920*1080 →480*480に切り取り  bの場合
                # frame = frame[550:1030,450:930]  # 1920*1080 →480*480に切り取り  cの場合
                # frame = frame[500:980,400:880]  # 1920*1080 →480*480に切り取り  dの場合
                frame = frame[700:1180,550:1030]  # 1920*1080 →480*480に切り取り  eの場合
...
# image1_path = output_dir + "/0001.jpg"  #a
# image2_path = output_dir + "/0406.jpg"  #
# image1_path = output_dir + "/0001.jpg"  #b
# image2_path = output_dir + "/0405.jpg"  #
# image1_path = output_dir + "/0001.jpg"  #c
# image2_path = output_dir + "/0383.jpg"  #
# image1_path = output_dir + "/0001.jpg"  #d
# image2_path = output_dir + "/0484.jpg"  #
image1_path = output_dir + "/0001.jpg"  #e
image2_path = output_dir + "/0512.jpg"  #
