...
for progress, bagfile in enumerate(bag_files):
    ...
    try:
        ...
        while True:
            ...
            # print(f"cur_time , pre_time = {cur_time}, {pre_time}")
        ...
        np.save(imu_filename, accel_data)
        print(f"accel_data is saved in {imu_filename}")
        # print(f"accel frame = {accel_data.shape}")
        pipeline.stop()
