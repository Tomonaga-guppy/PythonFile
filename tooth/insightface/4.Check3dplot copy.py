...
for i, npy_path in enumerate(npy_paths):
    ...
    scatter_seal = ax.scatter([], [], [], color='red', marker = "*", s = 60)
    scatter = ax.scatter([], [], [], color='blue')
    scatter_red = ax.scatter([], [], [], color='blue')
    scatter_green = ax.scatter([], [], [], color='blue')
    ...
    # アニメーションを保存する
    anim.save(save_dir + f'/animation_local_sagittal.mp4', fps=30)
