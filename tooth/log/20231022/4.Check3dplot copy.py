...
npy_paths = glob.glob(os.path.join(root_dir,"*_J2*/XYZ_localdata.npy"))
...
for i, npy_path in enumerate(npy_paths):
    ...
    def update(frame):
        ...
        line_y= art3d.Line3D([0,data[0,frame,30]],[0,data[2,frame,30]],[0,data[1,frame,30]], color='black')
        ax.add_line(line_y)
        line_y2= art3d.Line3D([0,data[0,frame,30]],[0,data[2,frame,30]],[0,data[1,frame,30]], color='black')
        ax2.add_line(line_y2)
