...
def MovieAnalyse_8(root_dir):
    pattern = os.path.join(root_dir, '*mkg2/*_original.mp4')
...
def SealDetection(cap_height,cap_width,img,mask1_x,mask2_x,mask1_y,mask2_y):
    ...
    seal_template = 'C:/Users/Tomson/BRLAB/tooth/Temporomandibular_movement/seal_template/seal-2.png'
    ...
    cv2.imwrite(root_dir + '20230606_mkg1/mask.jpg',mask2_img)
    #ガウガシアンフィルタで平滑化
    ...
    seal_template = 'C:/Users/Tomson/BRLAB/tooth/Temporomandibular_movement/seal_template/seal_black.png'
    template = cv2.imread(seal_template)
