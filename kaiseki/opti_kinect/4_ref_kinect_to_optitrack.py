...
def main():
    for condition_num in condition_keynum:
        ...
        df_diagonal_right.to_csv(f"df_diagonal_right_{condition_num}.csv")
        ...
        df_diagonal_left.to_csv(f"df_diagonal_left_{condition_num}.csv")
        ...
        df_frontal.to_csv(f"df_frontal_{condition_num}.csv")
