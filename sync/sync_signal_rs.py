...
SERIAL_MASTER = '231522070603'  # マスターカメラ
# SERIAL_SLAVE = '233722072880'   # スレーブカメラ
...
# master_sensor.set_option(rs.option.output_trigger_enabled, 1)
...
try:
    ...
    while True:
        ...
        #RGB画像と深度画像を結合
        images = np.hstack((master_color_image, master_depth_image))
        cv2.imshow("Images", images)
