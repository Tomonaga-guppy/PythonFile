...
input_path = r"C:\Users\zutom\output_test.mkv"

file_name = r"C:\Users\zutom\Open3D\examples\python\reconstruction_system\sensors\azure_kinect_mkv_reader.py"
pwd = os.path.dirname(file_name)
os.chdir(pwd)
